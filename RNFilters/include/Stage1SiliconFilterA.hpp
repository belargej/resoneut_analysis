...
#ifndef _Stage1_SiliconFilterA_H
#define _Stage1_SiliconFilterA_H
#include <TH2.h>
#include <cstdlib>
#include <string>
#include <new>
...
namespace RNfilters{
  ...
  class Stage1SiliconFilterA:public RN_Analyzer{
  private:    
  public:
    
    Stage1SiliconFilterA();
    virtual ~Stage1SiliconFilterA(){};
    ...
    ClassDef(Stage1SiliconFilterA,0);
  };
