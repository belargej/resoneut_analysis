...
bool ReconstructBeamSpotA::Begin(){
  ...
  hErCorrected = new TH1D("hErProtonCorrected","hErProtonCorrected",512,-1,10);
  hErCorrectedvProtonE = new TH2D ("hErCorrectedvProtE","hErCorrectedvProtE",512,-1,10,512,0,32);
  hErCorrectedvSiPhi = new TH2D ("hErCorrectedvSiPhi","hErCorrectedvSiPhi",512,-1,10,180,-180,180);
  hErCorrectedvICPhi = new TH2D ("hErCorrectedvICPhi","hErCorrectedvICPhi",512,-1,10,180,-180,180);
  hErCorrectedvICTheta = new TH2D ("hErCorrectedvICTheta","hErCorrectedvICTheta",512,-1,10,256,-1,14);
