...
namespace sim{
  ...
  RN_SimEvent::RN_SimEvent(double beam_energy,double beam_mass,
			   ...
			   double hi_mass){
    Init(beam_energy,beam_mass,target_mass,rad_mass,hi_mass);
  }
  
  void RN_SimEvent::Init(double beam_energy,double beam_mass,
			 double target_mass,double rad_mass,
			 double hi_mass){
    Marray.clear();
    LVarray.clear();
  ...
  void RN_SimEvent::Init(double parent_mass,double rad_mass,double hi_mass){
    Marray.clear();
    LVarray.clear();
  ...
  RN_SimEvent::RN_SimEvent(double parent_mass,double rad_mass,double hi_mass){
    Init(parent_mass, rad_mass, hi_mass);
  }
