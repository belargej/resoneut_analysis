...
S1TestClass::S1TestClass()
{
  
}


void S1TestClass::ResetGlobals(){
...
bool S1TestClass::TerminateIfLast(){
  /*
...
void LoadTemplateGates(){
  /*
    not a member of the S1TestClass class, this function serves to Load any gates that are unique to this analysis. The gates should be declared at the top of this file.
